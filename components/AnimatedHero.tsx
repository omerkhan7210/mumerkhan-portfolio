  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1360px] mx-auto px-6 md:px-10 relative z-10 w-full">
        ...
        {/* Status pill */}
        <div className="h-pill inline-flex items-center gap-2.5 rounded-full px-4 py-2 mb-10 font-body text-sm"
          style={{ border: '1px solid rgba(var(--fg-rgb),0.1)', color: 'var(--color-muted)' }}
        >
        ...
        <h1 className="mb-10" style={{ letterSpacing: '-0.03em' }}>
          {HEADING_LINES.map((line, li) => (
            <div
              key={li}
              style={{ overflow: 'hidden', paddingTop: '0.12em', paddingBottom: '0.22em' }}
            >
